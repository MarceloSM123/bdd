...
values ('1234567890','Marcelo', 'Salcedo', 'asd@gmail.com','23/05/1992',1);
insert into estudiantes (cedula, nombre, apellido, email,fecha_nacimiento,codigo_profesor)
values ('1232567890','Mariela', 'Cruz', 'cd@gmail.com','27/06/2000',2);
insert into estudiantes (cedula, nombre, apellido, email,fecha_nacimiento,codigo_profesor)
values ('1233567890','Marco', 'Espejo', 'esd@gmail.com','26/07/2021',3);
insert into estudiantes (cedula, nombre, apellido, email,fecha_nacimiento,codigo_profesor)
values ('1235567890','michele', 'velasquez', 'ved@gmail.com','25/08/1995',4);
insert into estudiantes (cedula, nombre, apellido, email,fecha_nacimiento,codigo_profesor)
values ('1236567890','Carla', 'Rodriguez', 'rad@gmail.com','24/09/1980',5);
insert into estudiantes (cedula, nombre, apellido, email,fecha_nacimiento,codigo_profesor)
values ('1237567890','Maria', 'smith', 'sbd@gmail.com','23/10/1992',6);
insert into estudiantes (cedula, nombre, apellido, email,fecha_nacimiento,codigo_profesor)
values ('1238567890','Diana', 'Salazar', 'sad@gmail.com','22/11/1990',7);
insert into estudiantes (cedula, nombre, apellido, email,fecha_nacimiento,codigo_profesor)
values ('1234597890','Fernanda', 'Ochoa', 'ocd@gmail.com','12/01/1991',8);
